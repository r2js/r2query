module.exports = (app) => {
  ...
  schema.plugin(query.plugin, {
    ...
    strict: true,
    properties: {
      filter: { type: 'object', properties: { name: { type: 'string', optional: true } } },
      sort: { type: 'object', properties: { createdAt: { type: 'number', eq: [-1], optional: true } } },
      limit: { type: 'number', max: 100 },
      skip: { type: 'number', max: 100 },
      projection: { type: 'object', properties: { name: { type: 'number', eq: 1, optional: true }, testRef1: { type: 'number', eq: 1, optional: true } } },
